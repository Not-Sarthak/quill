...
import MainBG from "../assets/images/section1/main-bg-0_1.png";
...
import Image1 from "../assets/images/section3/image1.png";
import Image2 from "../assets/images/section3/image2.png";
import Image3 from "../assets/images/section3/image3.png";
import Image4 from "../assets/images/section3/image4.png";
import Image5 from "../assets/images/section3/image5.png";
...
import Front1 from "../assets/images/section4/front1.png";
import Front2 from "../assets/images/section4/front2.png";
import Front3 from "../assets/images/section4/front3.png";
import Back1 from "../assets/images/section4/back1.png";
import Back2 from "../assets/images/section4/back2.png";
import Back3 from "../assets/images/section4/back3.png";
...
export const section1Content = {
  ...
  HorseImage,
  ShootingStarImage,
  title: "Where Bloggers",
  titlebetween: "And Their Fans",
  titlebelow: "Come Together"
};

export const section2Content = {
  items: [
    { counter: 345, after: "+", subtitle: "Active Communities" },
    { counter: 3, after: "K+", subtitle: "Total Blogs" },
    { counter: 8.4, after: "K+", subtitle: "Readers", decimals: true },
    { counter: 28, after: "+", subtitle: "Categories", decimals: true },
  ],
};

export const section3Content = {
  title: "Build your audience.",
  titlebelow: "Build your brand.",
  ITEMS: [
...
export const section4Content = {
  title: "Unleash The True Potential",
  titlebetween: "Of Your Blogs",
  titlebelow: "With The Power Of Our",
  maintitle: "Quill NFT Memberships",
  Front1,
  Front2,
  Front3,
  Back1,
...
export const footerContent = {
  ...
  subscribe: {
    title: "Subscribe to Quill newsletter",
    subtitle: "Get the latest blogs and updates",
  },
  socials: [
    { icon: BookIcon },
    { icon: RedditIcon },
  ...
  copyright: {
    left: "© 2023 Quill, All Rights Reserved.",
    center: "FIND: @quill.find",
    right: "BUIDL @FLOW Hackathon S2",
  },
};
